...
# Storage Structure
The repository does not implement Supabase Storage, Firebase Storage, or any other object storage workflow. Lost and found images are stored directly in `public.lost_found.image_url` as text data.

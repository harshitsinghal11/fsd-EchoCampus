        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              <li>
                <Link href={ROUTES.STUDENT.ANNOUNCEMENTS} className="text-text-muted hover:text-primary transition-colors duration-200 text-sm inline-flex items-center group">
                  Announcements
                </Link>
              </li>
              <li>
                <Link href={ROUTES.STUDENT.DIRECTORY} className="text-text-muted hover:text-primary transition-colors duration-200 text-sm inline-flex items-center group">
                  Directory
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href={ROUTES.STUDENT.LOST_FOUND} className="text-text-muted hover:text-primary transition-colors duration-200 text-sm inline-flex items-center group">
                  Lost & Found
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              <li>
                <a href="mailto:echo@campus.edu" className="group flex items-center text-text-muted hover:text-primary transition-colors duration-200 text-sm">

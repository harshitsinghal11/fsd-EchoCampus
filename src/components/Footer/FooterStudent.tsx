        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="/main/student/announcements" className="text-gray-300 hover:text-blue-400 transition-colors duration-200 text-sm">
                  Announcements
                </a>
              </li>
              <li>
                <a href="/main/student/directory" className="text-gray-300 hover:text-blue-400 transition-colors duration-200 text-sm">
                  Directory
                </a>
              </li>
              <li>
                <a href="/main/student/marketplace" className="text-gray-300 hover:text-blue-400 transition-colors duration-200 text-sm">
                  Marketplace
                </a>
              </li>
              <li>
                <a href="/main/student/lost-found" className="text-gray-300 hover:text-blue-400 transition-colors duration-200 text-sm">
                  Lost & Found
                </a>
              </li>
            </ul>

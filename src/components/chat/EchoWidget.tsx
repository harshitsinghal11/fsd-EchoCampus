        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              transition={{ duration: 0.2 }}
              className="fixed top-0 left-0 md:top-auto md:left-auto md:bottom-8 md:right-8 z-50 w-full h-[100dvh] md:w-[400px] md:h-[600px] md:max-h-[80vh] flex flex-col bg-surface md:border border-border md:rounded-2xl shadow-2xl overflow-hidden pointer-events-auto"
            >
              {/* Header */}
              <div className="p-4 pt-[calc(1rem+env(safe-area-inset-top))] md:pt-4 border-b border-border bg-surface flex items-center justify-between shrink-0">
              ...
              {/* Input */}
              <div className="p-4 pb-[calc(1rem+env(safe-area-inset-bottom))] md:pb-4 border-t border-border bg-surface shrink-0">
